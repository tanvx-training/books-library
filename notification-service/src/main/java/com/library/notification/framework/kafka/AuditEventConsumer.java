package com.library.notification.framework.kafka;

import com.library.notification.service.NotificationPreferencesService;
import com.library.notification.dto.event.AuditEventMessage;
...
public class AuditEventConsumer {
    ...
    @KafkaListener(
            ...
            properties = {"spring.json.value.default.type=com.library.notification.dto.event.AuditEventMessage"})
