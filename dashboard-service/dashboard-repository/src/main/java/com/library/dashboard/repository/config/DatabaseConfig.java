package com.library.dashboard.repository.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.library.dashboard.repository")
@EntityScan(basePackages = "com.library.dashboard.repository.entity")
@EnableJpaAuditing
