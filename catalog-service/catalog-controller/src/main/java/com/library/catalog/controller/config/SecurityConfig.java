package com.library.catalog.controller.config;
...
/**
 * Security configuration for OAuth2 resource server with JWT token validation.
 * This configuration enables the service to validate JWT tokens from Keycloak
 * and supports both direct API calls and API Gateway forwarded requests.
 */
@Configuration
@EnableWebSecurity
