...
/**
 * Request DTO for creating a new book with copies.
 * This matches the frontend 2-step process: book information + copy management.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CreateBookWithCopiesRequest {
    ...
    // Step 2: Copy Management
    @Valid
    @Size(min = 1, message = "At least one copy is required")
    private List<BookCopyRequest> copies;

    /**
     * Request DTO for book copy information
     */
    @Data
    @NoArgsConstructor
    @AllArgsConstructor
    public static class BookCopyRequest {
